...
import de.schliemannosaurusrex.kaniamp.sync.SyncState
import de.schliemannosaurusrex.kaniamp.sync.SyncViewModel
            ...
            is SyncState.Finished -> {
                ResultCard(
                    ...
                    lines = buildList {
                        ...
                        if (s.failed > 0) add("${s.failed} failed — will retry on next sync")
                    },
