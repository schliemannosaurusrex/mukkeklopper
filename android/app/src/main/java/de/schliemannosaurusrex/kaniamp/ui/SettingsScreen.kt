...
import de.schliemannosaurusrex.kaniamp.settings.ConnectionTest
import de.schliemannosaurusrex.kaniamp.settings.SettingsViewModel
...
fun SettingsScreen(
    ...
    if (showModeBDisclosure) {
        ...
        AlertDialog(
            ...
            text = {
                Text(
                    "KaniAmp uses your device's location permission only to read " +
