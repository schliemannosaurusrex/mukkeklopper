...
data class FolderEntry(
    /** Voller Pfad inkl. Schrägstrich am Ende, z. B. `Music/KaniAmp/`. */
    val path: String,
    /** Nur das letzte Segment, z. B. `KaniAmp`. */
    val name: String,
...
object FolderTree {
    ...
    /** Breadcrumb-Segmente: `Music/KaniAmp/` → [(Music, Music/), (KaniAmp, Music/KaniAmp/)]. */
